...
class TimelineAdapter(private val steps: List<TimelineStep>) : RecyclerView.Adapter<TimelineAdapter.TimelineViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TimelineViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            indicatorCircle.backgroundTintList = android.content.res.ColorStateList.valueOf(color)
            line.backgroundTintList = android.content.res.ColorStateList.valueOf(color)
